...
const projects = [
  ...
  },
  {
    ...
    excerptZh: "以弧形展示墙、收银台和灯光陈列，提升零售店进店观感。",
  ...
  },
  {
    ...
    excerptZh: "玄关鞋柜结合坐凳、镜面和展示格，让入户区域更整齐、更有到访观感。",
  ...
  },
  {
    ...
    excerptZh: "玻璃入口、石材立面和金属雨棚组合，让店面入口观感更干净高级。",
  ...
  },
  {
    ...
    excerptZh: "办公室入口采用铝框玻璃、石材门套和遮雨结构，提升专业到访观感。",
