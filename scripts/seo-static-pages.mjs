...
const staticDefs = [
  ...
  page("en", "/services/kitchen", "Kitchen Renovation Kuala Lumpur | FLASH CAST", "Kitchen renovation, cabinet replacement, countertop upgrade, plumbing, electrical, tiling, and appliance planning."),
