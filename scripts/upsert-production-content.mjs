...
const services = [
  {
    ...
    process_steps_zh: faq([["第一步", "了解需求、现场情况、预算和工期。"], ["第二步", "整理报价、材料建议和施工顺序。"], ["第三步", "安排施工、进度汇报、验收和售后说明。"]]),
    process_steps_en: faq([["Step 1", "Understand requirements, site condition, budget, and timeline."], ["Step 2", "Prepare quotation, material advice, and work sequence."], ["Step 3", "Manage construction, progress updates, handover, and after-sales notes."]]),
  ...
  },
  {
    ...
    suitable_for_zh: ["公寓厨房布局调整", "有地住宅干湿厨房规划", "旧厨房收纳与家电点位优化", "报价前确认柜体、水电与湿作范围"],
    suitable_for_en: ["Condo kitchen layout updates", "Landed-home dry and wet kitchen planning", "Old-kitchen storage and appliance-point improvements", "Cabinet, service-point, and wet-work review before quotation"],
    common_projects_zh: ["橱柜与台面选择评估", "厨房墙地面范围检查", "水电与家电点位协调", "清楚标注的厨房规划概念"],
    common_projects_en: ["Cabinet and countertop option review", "Kitchen wall and floor scope review", "Plumbing and appliance-point coordination", "Clearly labeled kitchen-planning concepts"],
    scope_items_zh: ["现场量尺", "动线与收纳规划", "柜体、台面与家电点位确认", "报价范围、安装与交付检查"],
    scope_items_en: ["Site measurement", "Workflow and storage planning", "Cabinet, countertop, and appliance-point review", "Quotation scope, installation, and handover checks"],
    ...
    faqs_zh: faq([["厨房装修报价受什么影响？", "橱柜尺寸、台面选择、五金、家电点位、给排水、湿作、墙地面、拆除与安装复杂度都会影响报价。"], ["可以只做橱柜和台面吗？", "可以先评估该范围；如涉及水电、墙地面或防水相关工作，需要一起确认施工边界。"]]),
    faqs_en: faq([["What affects a kitchen renovation quotation?", "Cabinet size, countertop choice, hardware, appliance points, plumbing, wet works, finishes, demolition, and installation complexity affect the quotation."], ["Can I update only cabinets and countertops?", "That scope can be reviewed first. Connected plumbing, electrical, wall, floor, or waterproofing-related work should be identified separately."]]),
