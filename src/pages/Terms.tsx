...
const termsCopy = {
  en: {
    ...
    sections: [
      ...
      { title: "5. Warranty", body: "After-sales or warranty terms must be stated in the project agreement. Coverage may vary by project type, scope, and material supplier terms." },
