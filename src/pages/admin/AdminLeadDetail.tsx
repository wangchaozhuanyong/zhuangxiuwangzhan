          ...
          <>
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div>
                  <h1 className="font-display text-2xl font-bold">{lead.name || "Lead"}</h1>
                ...
                <div className="flex gap-2">
                  ...
                  <Button asChild variant="outline"><a href={`tel:${String(lead.phone || "").replace(/[^\d+]/g, "")}`}>Call</a></Button>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
              <section className="rounded-xl border border-border bg-card p-6">
                ...
                <div className="grid gap-4 text-sm md:grid-cols-2">
                  <div><span className="text-muted-foreground">Project:</span> {lead.project_type || "-"}</div>
                  <div><span className="text-muted-foreground">Location:</span> {lead.location || "-"}</div>
                  <div className="md:col-span-2"><span className="text-muted-foreground">Message:</span><p className="mt-1 whitespace-pre-wrap">{lead.message || "-"}</p></div>
