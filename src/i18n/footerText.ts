...
export const footerCopy = {
  en: {
    ...
    spaceServicesTitle: "Spaces & Services",
    brandContactTitle: "Studio & Contact",
    areasSummary: "Serving Kuala Lumpur, Selangor and the Klang Valley.",
  ...
  zh: {
    ...
    callAction: "点击拨打",
    emailAction: "发送邮件",
    spaceServicesTitle: "空间与服务",
    brandContactTitle: "品牌与联系",
    areasSummary: "服务吉隆坡、雪兰莪及巴生谷地区。",
    servicesTitle: "服务项目",
    companyTitle: "公司信息",
    areasTitle: "服务地区",
    rights: "保留所有权利。",
...
export const footerUiText = {
  en: {
    ...
    panoramaAlt: "FLASH CAST interior planning reference",
    finalStatement: "Spaces planned with intent.",
    directoryTitle: "Explore",
  ...
  zh: {
    ...
    panoramaAlt: "FLASH CAST 已完成的室内项目",
    finalStatement: "认真完成空间，也认真完成生活。",
    directoryTitle: "网站目录",
    backToTop: "返回顶部",
    languageLabel: "语言",
  },
