...
export const contactPageText = {
  en: {
    ...
    hoursText: "Visits and consultations by prior arrangement",
    servicesTitle: "Our Services",
    quoteCta: "Get a Free Quote",
    whatsappCta: "WhatsApp Us",
    callAction: "Call now",
    emailAction: "Send email",
    navigateAction: "Get directions",
    navigationTitle: "Choose a navigation app",
    navigationDescription: "Open the office destination in your preferred map app.",
    googleMaps: "Google Maps",
    waze: "Waze",
    appleMaps: "Apple Maps",
    whatsappMessage: "Hi FLASH CAST, I found your contact page. My project location is: \nProperty type: \nRenovation scope: \nI can share site photos.",
  ...
  zh: {
    ...
    emailAction: "发送邮件",
    navigateAction: "前往导航",
    navigationTitle: "选择导航地图",
    navigationDescription: "使用您习惯的地图打开办公室目的地。",
    googleMaps: "Google 地图",
    waze: "Waze",
    appleMaps: "Apple 地图",
    whatsappMessage: "你好 FLASH CAST，我正在查看联系页面。\n项目地区：\n房屋类型：\n装修范围：\n我可以发送现场照片。",
    successTitle: "信息已发送！",
    successThanks: "谢谢您",
