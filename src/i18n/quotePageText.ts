export const quotePageText = {
  en: {
    ...
    privacyNote: "We use these details only to review and follow up on your renovation enquiry during business hours.",
    privacyLink: "Read our Privacy Policy",
    validationSummary: "Please review {count} field(s):",
    ...
    successNoRepeat: "Your request has been recorded. Please do not submit it again.",
    ...
    trustPoints: [
      ...
      "Project scope and after-sales terms confirmed in the quotation",
    ],
    ...
    whatsappMessage: "Hi FLASH CAST, I found your renovation quote page. My project location is: \nProperty type: \nRenovation scope: \nI can share site photos.",
    contactLabel: "Phone / WhatsApp",
    hours: "Consultations by prior arrangement",
    sunday: "Contact us before visiting",
    office: "Taman United, Kuala Lumpur",
    navServices: "Quick Links",
    navProjects: "Projects",
    navFaq: "FAQ",
    navProjectsHint: "View project references and labelled concepts",
  ...
  zh: {
    ...
    submit: "提交报价请求",
    submitting: "提交中...",
    privacyNote: "这些资料只用于在营业时间查看并跟进你的装修咨询。",
    privacyLink: "查看隐私政策",
    validationSummary: "请检查以下 {count} 个字段：",
    ...
    successNoRepeat: "你的请求已记录，请不要重复提交。",
    successProject: "项目：",
    successLocation: "地点：",
    successBudget: "预算：",
