export const adminMediaLibraryText = {
  ...
  editDialogDescription: {
    en: "Update folder, category, and image descriptions used by frontend content editors.",
    zh: "修改文件夹、用途分类和前台内容编辑会用到的图片说明。",
  },
  folderLabel: { en: "Folder", zh: "文件夹" },
  usageTypeLabel: { en: "Usage category", zh: "用途分类" },
  altZhLabel: { en: "Chinese image description", zh: "中文图片说明" },
  altEnLabel: { en: "English image description", zh: "英文图片说明" },
  searchLabel: { en: "Search media", zh: "搜索媒体" },
  categoryLabel: { en: "Media category", zh: "媒体分类" },
