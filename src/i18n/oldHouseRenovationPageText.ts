export const oldHouseRenovationPageText = {
  en: {
    ...
    beforeAfterAlt: "Before and after old house renovation",
    serviceAlt: "Old house renovation in progress",
    ...
    challenges: [
      { icon: "alert", title: "Cracked Walls & Structure", desc: "Settlement cracks and weakened plaster need proper inspection before finishing work begins." },
  ...
  zh: {
    ...
    challenges: [
      { icon: "alert", title: "墙身裂缝与结构老化", desc: "旧屋常见沉降、墙裂或批荡老化，需要先评估再修复。" },
