...
const sitePageRows = [
  {
    ...
    seo_description_zh: "了解 FLASH CAST 在吉隆坡与雪兰莪的装修规划、设计协调与项目工作方式。",
    seo_description_en: "Learn how FLASH CAST approaches renovation planning, design coordination, and project delivery in Kuala Lumpur and Selangor.",
    content_en: "Learn more about FLASH CAST SDN. BHD., our renovation approach, working principles, and the way we support residential and commercial project discussions across Kuala Lumpur and Selangor.",
    image_url: "/images/heroes/v2/hero-about-premium.webp",
  ...
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-services-premium.webp",
  ...
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-materials-premium.webp",
  ...
  },
  {
    page_key: "products",
    path: "/products",
    title_zh: "为真实空间选择合适商品",
    title_en: "Products selected for real spaces",
    subtitle_zh: "装修商品目录",
    subtitle_en: "Renovation product directory",
    description_zh: "把饰面、柜体、表面材料与配件放进真实装修场景中比较，同时了解规格、适用方式和安装注意事项。",
    description_en: "Browse finishes, built-ins, surfaces, and fittings together with practical specification and installation guidance for real renovation projects.",
    image_url: "/images/heroes/v2/hero-materials-premium.webp",
    alt_zh: "FLASH CAST 装修商品目录",
    alt_en: "FLASH CAST renovation product directory",
    seo_title_zh: "吉隆坡装修商品与材料 | FLASH CAST",
    seo_title_en: "Renovation Products Kuala Lumpur | FLASH CAST",
    seo_description_zh: "浏览 FLASH CAST 装修商品、材料、饰面、柜体、地板、台面与配件，并咨询项目适用方案。",
    seo_description_en: "Browse renovation products, materials, finishes, cabinets, flooring, surfaces, and fittings available for project consultation with FLASH CAST.",
    seo_keywords_zh: "吉隆坡装修商品, 装修材料, 橱柜, 地板, 台面",
    seo_keywords_en: "renovation products Kuala Lumpur, cabinets, flooring, surfaces, fittings",
    status: "published",
    sort_order: 19,
  },
  {
    ...
    path: "/promotions",
    title_zh: "条件清楚的优惠活动",
    title_en: "Promotions with clear conditions",
    subtitle_zh: "当前优惠",
    subtitle_en: "Current offers",
    description_zh: "所有优惠都需要根据实际现场、工程范围和正式报价确认。页面不会展示未经确认的折扣，也不会隐藏适用条件。",
    description_en: "Every offer is confirmed against your actual site, scope, and quotation. We do not present unverified discounts or hide the applicable conditions.",
    cta_description_zh: "最终优惠以正式书面报价明确列出的内容为准。",
    cta_description_en: "Final benefits are confirmed only when stated in the written quotation.",
    image_url: "/images/heroes/v2/hero-quote-premium.webp",
    alt_zh: "FLASH CAST 装修优惠活动",
    alt_en: "FLASH CAST renovation promotions",
    seo_title_zh: "吉隆坡装修优惠活动 | FLASH CAST",
    seo_title_en: "Renovation Promotions Kuala Lumpur | FLASH CAST",
    seo_description_zh: "查看 FLASH CAST 当前装修优惠咨询方向与报价确认前的适用条件。",
    seo_description_en: "Review current FLASH CAST renovation promotion enquiries and the conditions that apply before quotation confirmation.",
    seo_keywords_zh: "吉隆坡装修优惠, 装修报价优惠, FLASH CAST 活动",
    seo_keywords_en: "renovation promotions Kuala Lumpur, renovation offer, FLASH CAST",
    items_zh: [...promotionsPageText.zh.defaultOffers],
    items_en: [...promotionsPageText.en.defaultOffers],
    status: "published",
    sort_order: 25,
  },
  {
    ...
    path: "/locations",
    title_zh: "装修服务地区",
    title_en: "Renovation service areas",
    subtitle_zh: "服务覆盖范围",
    subtitle_en: "Service coverage",
    description_zh: "查看 FLASH CAST 在吉隆坡、雪兰莪与巴生谷常见的房产类型、申请事项与装修需求。",
    description_en: "Review the property types, approval considerations, and renovation needs commonly handled across Kuala Lumpur, Selangor, and Klang Valley.",
    image_url: "/images/heroes/v2/hero-projects-premium.webp",
    alt_zh: "FLASH CAST 装修服务地区",
    alt_en: "FLASH CAST renovation service areas",
    seo_title_zh: "吉隆坡与雪兰莪装修服务地区 | FLASH CAST",
    seo_title_en: "Renovation Service Areas KL & Selangor | FLASH CAST",
    seo_description_zh: "查看 FLASH CAST 在吉隆坡、雪兰莪与巴生谷的装修服务覆盖地区。",
    seo_description_en: "Explore FLASH CAST renovation service areas across Kuala Lumpur, Selangor, and Klang Valley.",
    seo_keywords_zh: "吉隆坡装修地区, 雪兰莪装修公司, 巴生谷装修服务",
    seo_keywords_en: "renovation areas Kuala Lumpur, Selangor renovation company, Klang Valley renovation",
    status: "published",
    sort_order: 28,
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-faq-premium.webp",
  ...
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-contact-premium.webp",
  ...
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-blog-premium.webp",
  ...
  },
  {
    ...
    image_url: "/images/heroes/v2/hero-process-premium.webp",
...
const cmsPageRows = [
  {
    ...
    title_zh: "首页",
    title_en: "Home",
    seo_title_zh: "吉隆坡装修公司 | 住宅、商业装修与定制柜 | FLASH CAST",
    seo_description_zh: "FLASH CAST 为吉隆坡、雪兰莪与巴生谷提供住宅装修、旧屋翻新、厨房与浴室、办公室与店铺装修、定制柜体、材料建议和施工协调。提交空间照片、地点与计划范围，获取免费报价。",
    seo_title_en: "Renovation Company Kuala Lumpur & Selangor | FLASH CAST",
    seo_description_en: "FLASH CAST plans and coordinates home and commercial renovation across Kuala Lumpur, Selangor, and Klang Valley, including kitchens, bathrooms, offices, shops, custom built-ins, material advice, and site work.",
    status: "published",
    sort_order: 0,
  },
];
...
const homeSections = [
  {
    ...
    items_en: [
      ...
      { icon: "users", value: "Homes & Businesses", label_en: "Residential and Commercial", desc_en: "Support for home renovation, office fit-out, shop renovation, built-in furniture, and selected industrial spaces." },
    ...
    items_zh: [
      ...
      { icon: "users", value: "住宅与商业", label_zh: "住宅和商业项目", desc_zh: "可按需求沟通住宅装修、办公室装修、店铺装修、定制柜体和部分工业空间。" },
      { icon: "shieldcheck", value: "SSM", label_zh: "注册公司", desc_zh: "网站清楚展示公司注册、地址和联系方式，方便客户核对。" },
    ],
...
const faqRows = {
  home: homeFAQs.map((faq, index) => ({
    page_key: "home",
    question_en: faq.q,
    question_zh: faq.qZh || zh(faq.q),
    answer_en: faq.a,
    answer_zh: faq.aZh || zh(faq.a),
    status: "published",
    sort_order: (index + 1) * 10,
  })),
  general: [
...
const aboutSections = [
  {
    ...
    content_en: "FLASH CAST SDN. BHD. supports renovation planning, design coordination, built-in work, and project delivery discussions for residential and commercial spaces in Kuala Lumpur and Selangor.",
    content_zh: "FLASH CAST SDN. BHD. 为吉隆坡与雪兰莪的住宅和商业空间提供装修规划、设计协调、定制工程与项目交付沟通。",
  ...
  },
  {
    ...
    content_en: "We help clients clarify scope, site conditions, material direction, coordination needs, and the next practical step before work begins.",
    content_zh: "我们协助客户在开工前理清工程范围、现场状况、材料方向、协调需求与下一步安排。",
    items_en: [
      "Project discussions start with the space, site condition, intended use, priorities, and confirmed scope.",
      "Responsibilities, exclusions, change handling, and after-sales terms should be recorded in the quotation or project documents.",
      "We also discuss artistic wall coating options for homes and commercial spaces when this finish suits the project.",
    ],
    items_zh: [
      "项目沟通从空间、现场状况、使用需求、优先项与确认范围开始。",
      "职责、排除项、变更方式与售后条款应记录在报价单或项目文件中。",
      "如果艺术墙面涂装适合项目，可进一步讨论材料、质感与样板方向。",
    ],
    image_url: "/images/heroes/hero-about.webp",
    status: "published",
    sort_order: 20,
  ...
  },
  {
    ...
    title_en: "Our Team",
    title_zh: "我们的团队",
    subtitle_en: "Coordination areas are defined according to the confirmed project scope.",
    content_en: "Design, built-in, material, approval, and site coordination needs are clarified before work proceeds.",
    content_zh: "设计、定制木作、材料、准证与现场协调需求会在开工前理清。",
  ...
  },
  {
    ...
    title_en: "How a Project Moves Forward",
    title_zh: "项目如何推进",
    subtitle_en: "A practical sequence from first review to handover follow-up.",
    content_en: "Each stage depends on the confirmed scope, site condition, approvals, materials, and project documents.",
    content_zh: "每个阶段都要以已确认的范围、现场状况、准证、材料与项目文件为准。",
...
const beforeAfterRows = [
  ["Kitchen Planning Comparison", "厨房规划对比", "", "Existing reference and planning direction for layout discussion; not verified completed-customer proof.", "用于布局沟通的现况参考与规划方向，不作为已核实客户完工证明。", "/images/before-after/before-kitchen.webp", "/images/before-after/after-kitchen.webp"],
  ["Living Room Planning Comparison", "客厅规划对比", "", "Existing reference and planning direction for visual discussion; not verified completed-customer proof.", "用于视觉沟通的现况参考与规划方向，不作为已核实客户完工证明。", "/images/before-after/before-living.webp", "/images/before-after/after-living.webp"],
  ["Bathroom Planning Comparison", "浴室规划对比", "", "Existing reference and planning direction for scope discussion; not verified completed-customer proof.", "用于范围沟通的现况参考与规划方向，不作为已核实客户完工证明。", "/images/before-after/before-bathroom.webp", "/images/before-after/after-bathroom.webp"],
  ...
  before_image_url,
  after_image_url,
  alt_en: `${title_en}: existing reference and planning direction`,
  alt_zh: `${title_zh}：现况参考与规划方向`,
  status: "published",
  sort_order: (index + 1) * 10,
}));
