...
const homeSections = [
  {
    ...
    items_zh: [
      { icon: "star", value: "Scope", label_zh: "清楚规划范围", desc_zh: "报价前先了解现场情况、使用需求、材料、预算和时间安排。" },
      { icon: "clock", value: "KL & Selangor", label_zh: "本地服务区域", desc_zh: "主要处理 Kuala Lumpur、Selangor 和附近 Klang Valley 区域的装修咨询。" },
