...
const cmsPageRows = [
  {
    ...
    seo_description_zh: "FLASH CAST SDN. BHD. 为吉隆坡、雪兰莪与巴生谷提供住宅装修、厨房、浴室、办公室、店铺、定制家具、旧屋翻新与装修申请协调。提交照片和需求，获取下一步建议。",
    seo_title_en: "Renovation Company Kuala Lumpur | Home & Commercial Renovation | FLASH CAST",
    seo_description_en: "FLASH CAST SDN. BHD. provides home and commercial renovation services in Kuala Lumpur, Selangor, and Klang Valley, including kitchens, bathrooms, offices, shops, built-ins, old-house renovation, and approval coordination.",
    status: "published",
    sort_order: 0,
  },
];
