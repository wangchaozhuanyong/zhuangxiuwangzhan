...
const sitePageRows = [
  ...
  },
  {
    ...
    seo_keywords_zh: "马来西亚装修常见问题, 吉隆坡装修问答, 定制家具 FAQ, DBKL 装修准证",
...
const homeSections = [
  {
    ...
    items_en: [
      { icon: "star", value: "200+", label_en: "Completed Projects", desc_en: "Across Kuala Lumpur and Selangor for residential, commercial, and industrial spaces" },
      { icon: "clock", value: "10+", label_en: "Years Experience", desc_en: "A decade of renovation experience in the Malaysian market" },
      ...
      { icon: "shieldcheck", value: "SSM", label_en: "Registered Company", desc_en: "Fully registered with workmanship warranty on all projects" },
    ],
    items_zh: [
      { icon: "star", value: "200+", label_zh: "完成项目", desc_zh: "覆盖吉隆坡与雪兰莪的住宅、商业和工业项目" },
      { icon: "clock", value: "10+", label_zh: "行业经验", desc_zh: "在马来西亚装修市场拥有十年以上经验" },
      { icon: "users", value: "Trusted", label_zh: "业主与企业客户信赖", desc_zh: "回头客户与转介绍是我们最重要的认可" },
...
const aboutSections = [
  ...
  },
  {
    ...
    content_zh: "办公室位于 Taman United, Kuala Lumpur。",
    items_en: [],
    items_zh: [],
    status: "published",
    sort_order: 70,
