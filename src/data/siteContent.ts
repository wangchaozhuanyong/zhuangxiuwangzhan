/** * Site-wide content data - homepage sections, about page, process steps, etc. * All content is centralized here for easy updates without touching components. */ import { LucideIcon } from "lucide-react";
import {
  Paintbrush,
  Wrench,
  Layers,
  ...
  Briefcase,
  Store,
} from "lucide-react"; // ============ SECTION HEADERS ============
export const sectionHeaders = {
  services: {
    title: "Our Renovation Services",
    subtitle:
      "From residential interiors to commercial fit-outs - professional renovation solutions for every space in Kuala Lumpur and Selangor.",
  },
  whyChooseUs: {
    title: "Why Choose FLASH CAST",
    subtitle:
      "We focus on practical renovation planning, reliable execution, and quality finishing. Here's what sets us apart.",
  },
...
export const trustStats: TrustStat[] = [
  ...
  },
  {
    icon: Users,
    value: "Trusted",
    label: "By Homeowners & Businesses",
    desc: "Repeat clients and referrals are our strongest endorsement",
    iconClass: "text-gold",
  },
  {
    icon: ShieldCheck,
...
export const processSteps: ProcessStep[] = [
  {
    ...
    details: [
      "Submit enquiry via website, WhatsApp, or phone",
      "Discuss requirements, timeline, and budget",
      "We provide initial advice and recommendations",
    ],
  },
  {
    num: "02",
  ...
  },
  {
    ...
    details: [
      ...
      "All trades executed by our team",
...
export const homepageProcessSteps: HomepageProcessStep[] = [
  {
    num: "01",
    title: "Consultation",
    desc: "We understand your goals, space, style, and budget.",
  },
  {
    num: "02",
    title: "Site Measurement",
    desc: "We inspect the site and confirm key dimensions.",
  },
  {
    num: "03",
    title: "Design Proposal",
    desc: "We prepare layout ideas and visual direction.",
  },
  {
    num: "04",
    title: "Quotation & Material Selection",
    desc: "We provide a clear breakdown and discuss materials.",
  },
  {
    num: "05",
    title: "Construction",
    desc: "Work is managed by our team with site supervision.",
  },
  {
    num: "06",
    title: "Handover",
...
export const homepageProcessIntro =
  "A clear, structured process from first contact to project handover. Every step is designed to give you confidence and control over your renovation."; // ============ SERVICE AREA SECTION ============
...
export const serviceAreas: ServiceAreaItem[] = [
  {
    ...
    slug: "kuala-lumpur",
    areas:
      "Mont Kiara, Bangsar, Cheras, Kepong, Sentul, Sri Hartamas, City Centre",
  },
  {
    name: "Petaling Jaya",
    slug: "petaling-jaya",
    areas: "SS2, Damansara, Kelana Jaya, PJ New Town, Section 17, Taman SEA",
  },
  {
    name: "Subang Jaya",
    slug: "subang-jaya",
    areas: "USJ, SS15, SS16, Sunway, Putra Heights",
  },
  {
    name: "Shah Alam",
    slug: "selangor",
    areas: "All sections, Setia Alam, Kota Kemuning, Bukit Jelutong",
  },
  {
    name: "Puchong",
    slug: "selangor",
    areas: "Bandar Puteri, IOI Boulevard, Taman Puchong",
  },
  {
    name: "Cheras",
    slug: "cheras",
    areas: "Taman Connaught, Taman Midah, Taman Segar, Batu 9",
  },
];
