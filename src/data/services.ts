...
const commercialImg = "/images/services/commercial-works.webp";
...
export const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    description: "A well-designed bathroom improves daily comfort and adds value to your property. Our bathroom renovation service covers demolition, waterproofing, tiling, vanity installation, shower system upgrade, toilet replacement, plumbing, and all finishing works. We pay special attention to waterproofing — the most critical aspect of any bathroom renovation. Our waterproofing process includes multiple layers of membrane application and a 48-hour water test before tiling begins. We use quality tiles, premium sanitary ware, and durable hardware to create bathrooms that look good and last.",
  ...
  },
  {
    ...
    description: "Many Malaysian homeowners inherit or purchase older properties that need major upgrading. Our Old House Renovation service handles the unique challenges of aging buildings — cracked walls, outdated wiring, old plumbing, termite damage, roof leaks, and worn-out interiors. We assess the structural condition of your property and create a renovation plan that addresses both safety concerns and aesthetic goals. Our team has extensive experience with Malaysian terrace houses, semi-detached homes, and bungalows built in the 1970s-1990s.",
