...
export const materialsData: MaterialCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "floor-4", name: "灰橡木乙烯基地板", slug: "vinyl-plank-ash-grey", category: "Flooring", subcategory: "vinyl-plank", type: "乙烯基地板", color: "灰橡木", texture: "木纹", suitableSpaces: ["Bedroom", "Living Room", "Office"], recommendedPairing: "适合搭配白色和灰色系室内风格", description: "2mm 自粘式乙烯基地板，属于较亲民的材料选择。", note: "不建议用于潮湿区域。", image: vinylAshGreyImg },
    ],
  },
  {
    name: "Doors & Windows",
