...
export const locationsData: Record<string, LocationData> = {
  ...
  "cheras": {
    ...
    nameZh: "蕉赖",
    slug: "cheras",
    metaTitle: "Home & Terrace Renovation Cheras | FLASH CAST",
    metaTitleZh: "蕉赖装修服务 | 排屋翻新与公寓改造 | FLASH CAST",
    description: "Plan home and terrace renovation in Cheras with FLASH CAST. Review Taman Connaught & Midah upgrades, DBKL / MPKJ permit boundaries, and transparent quotation scope.",
    descriptionZh: "FLASH CAST 为蕉赖（Cheras）提供住宅排屋与公寓翻新服务。涵盖康乐（Taman Connaught）、美达花园排屋翻新、DBKL 与 MPKJ 准证、水电重拉与明细报价。",
    intro: "Cheras is an expansive, vibrant district straddling the border between Kuala Lumpur and Selangor, known for dense residential neighborhoods, traditional commercial shoplots, and burgeoning transit-oriented high-rises along the MRT Kajang Line. Renovation requirements in Cheras vary significantly: mature double-storey terrace houses across Taman Connaught, Taman Midah, Taman Yulek, and Taman Segar frequently require major structural modernizations, including rear kitchen extensions, roof truss refurbishment, full rewiring from single-phase to 3-phase, and damp-proofing party walls. In contrast, modern developments like EkoCheras and Sunway Velocity focus on contemporary space optimization, custom carpentry, and strict building management compliance. Critically, Cheras spans two separate municipal jurisdictions: Cheras KL falls under DBKL, while Cheras Selangor (including Bandar Mahkota Cheras and Bandar Sungai Long) is governed by MPKJ. FLASH CAST delivers comprehensive local renovation planning, council submissions, trade execution, and itemized quotations tailored to Cheras properties.",
    introZh: "蕉赖（Cheras）是巴生谷极具代表性、跨越吉隆坡与雪兰莪双重地界的成熟大型生活圈，以密集的华人传统住宅社区、老街商业店铺以及捷运加影线沿线的高层综合体而闻名。在蕉赖，装修需求呈现鲜明的层次：位于康乐花园（Taman Connaught）、美达花园（Taman Midah）、友力花园（Taman Yulek）等成熟社区的 30–40 年双层排屋，普遍面临后院扩建、屋顶瓦片防漏、单相电升三相电（3-Phase 60A）及老化铁水管换新等全屋结构性翻新；而 EkoCheras、Sunway Velocity 等现代公寓则更侧重于空间动线重构、定制内嵌收纳与管理处严谨的工期报备。尤为关键的是，蕉赖分属两大市政局管辖：吉隆坡蕉赖归 DBKL 管辖，雪兰莪蕉赖（皇冠城、双溪龙等）则由加影市议会（MPKJ）管辖。FLASH CAST 提供从实地勘测、结构排查、市政报批到精细化施工交付的全方位服务。",
    propertyTypes: [
      "Mature double-storey terrace houses (Taman Connaught, Taman Midah, Taman Yulek)",
      "Modern transit-oriented condominiums & serviced suites (EkoCheras, Sunway Velocity, Aster)",
      "Suburban gated & guarded landed communities (Bandar Mahkota Cheras, Sungai Long)",
      "Commercial shophouses & retail storefronts (Taman Connaught night market area, Cheras Traders Square)",
      "Older low-rise walk-up apartments and flats (Taman Segar, Maluri)",
    ],
    propertyTypesZh: [
      "成熟双层排屋与老房住宅（康乐花园、美达花园、友力花园）",
      "捷运沿线现代高层公寓与服务式住宅（EkoCheras、Sunway Velocity、Aster）",
      "雪兰莪蕉赖围篱式有地社区（皇冠城 Bandar Mahkota Cheras、双溪龙 Sungai Long）",
      "商业沿街店铺与门市门面（康乐夜市商业街、Cheras Traders Square）",
      "成熟低密度无电梯旧式公寓与组屋（Taman Segar、马鲁里 Maluri）",
    ],
    commonNeeds: [
      "Complete terrace house modernization: single/double-storey rear kitchen extension and car porch retiling",
      "Roof leak repair and ceiling replacement: truss inspection, waterproofing underlay, and gutter overhaul",
      "Comprehensive electrical & plumbing renewal: 3-phase power conversion and PPR pipe replumbing",
      "Wet and dry kitchen separation with heavy-duty custom cabinetry and granite/quartz countertops",
      "Full bathroom overhaul: membrane waterproofing, concealed piping, and anti-slip floor tiles",
      "Condo interior redesign and space planning for young couples and multi-generational families",
    ],
    commonNeedsZh: [
      "成熟排屋全屋现代化翻新：后院厨房单/双层扩建与车房全瓷砖翻新",
      "屋顶防漏修缮与吊顶更换：屋架结构检查、防水底膜铺设与雨水槽重做",
      "水电管路全面换新：单相电升级三相电（3-Phase 60A）与老化给水管换新",
      "干湿分离厨房重构：抗油烟定制防潮橱柜、耐磨石英石/花岗岩台面与专用排烟道",
      "卫生间彻底翻新：地面多层防水卷材施工、暗装排污管道与防滑瓷砖升级",
      "高层公寓空间优化与定制收纳：主卧衣帽间、玄关储物柜与儿童房功能区规划",
    ],
    constructionNotes: "Renovations in Cheras require careful attention to municipal boundaries: Cheras Kuala Lumpur (e.g. Taman Connaught, Taman Midah, Taman Segar, Maluri) is governed by Dewan Bandaraya Kuala Lumpur (DBKL), whereas Cheras Selangor (e.g. Mahkota Cheras, Balakong, Sungai Long) falls under Majlis Perbandaran Kajang (MPKJ). Structural additions such as kitchen extensions or car porch modifications require formal building plan approvals from the applicable council through a registered architect or structural engineer. Older houses should also undergo structural stability and party-wall dampness assessments before commencing hacking. For high-density condominiums along the MRT corridor, renovations must adhere strictly to building management (JMB/MC) guidelines, including security deposits, elevator protective padding, and designated delivery hours.",
    constructionNotesZh: "在蕉赖进行装修必须首先明确市政管辖界限：吉隆坡蕉赖辖区（如康乐花园、美达花园、斯嘉镇、马鲁里等）归属吉隆坡市政局（DBKL）；而雪兰莪蕉赖辖区（如皇冠城、无拉港、双溪龙等）则归属加影市议会（MPKJ）。涉及后院外扩、车房顶棚重造或敲除承重墙的有地住宅，必须由注册建筑师向对应市政局报批施工图纸并取得准证。对于 30 年以上老排屋，动工前建议对共用隔墙潮湿与屋架沉降进行全面排查。捷运沿线的高层公寓则需严格遵循物业管理处（JMB/MC）规约，按期缴纳施工押金、铺设电梯保护层并在指定非高峰时段运送建材。",
    projects: [
      {
        title: "Commercial Glass Entrance & Facade",
        type: "Commercial",
        image: commercialImg,
        slug: "cheras-glass-shopfront-facade",
        href: "/projects/cheras-glass-shopfront-facade",
      },
      {
        title: "Cheras Retail Boutique Fit-Out",
        type: "Commercial",
        image: commercialImg,
        slug: "cheras-retail-boutique-renovation",
        href: "/projects/cheras-retail-boutique-renovation",
      },
      {
        title: "Cheras Commercial Storage Fit-Out",
        type: "Commercial",
        image: commercialImg,
        slug: "cheras-stockroom-shelving-system",
        href: "/projects/cheras-stockroom-shelving-system",
      },
    ],
    faqs: [
      {
        q: "Which areas in Cheras do you serve for terrace and condo renovations?",
        a: "We cover all residential and commercial precincts across Cheras, including Taman Connaught, Taman Midah, Taman Yulek (Taman Cheras), Taman Segar, Taman Taynton View, Maluri, Bandar Tun Razak, as well as Cheras South townships like Bandar Mahkota Cheras, Bandar Sungai Long, and Cheras Perdana.",
      },
      {
        q: "How do I know whether my Cheras property requires DBKL or MPKJ renovation permits?",
        a: "Jurisdiction is determined by whether your property address falls in the Federal Territory of Kuala Lumpur or the State of Selangor. Properties in inner Cheras (Taman Connaught, Midah, Segar, Maluri) fall under DBKL. Southern Cheras areas (Mahkota Cheras, Sungai Long, Balakong) fall under MPKJ. Any structural alteration or rear extension requires formal architectural plans submitted to the respective council.",
      },
      {
        q: "How do you handle persistent roof leaks and damp party walls in older Cheras terrace houses?",
        a: "Older Cheras homes often suffer from degraded mortar flashing along shared party walls and weathered roof battens. We conduct an attic truss inspection, replace cracked clay tiles, apply waterproof flashing membranes along party-wall parapets, and apply hydrostatic anti-damp coatings before repainting.",
      },
      {
        q: "What is required to renovate a condominium unit along the Cheras MRT corridor?",
        a: "Before commencing work in buildings like EkoCheras, Sunway Velocity, or Aster Residence, you must submit architectural layout plans to the JMB/MC, place a renovation security deposit, submit contractor insurance (CAR policy), book the service lift for material delivery, and restrict noisy hacking to approved weekday hours.",
      },
    ],
    faqsZh: [
      {
        q: "FLASH CAST 在蕉赖（Cheras）具体服务哪些片区？",
        a: "我们的服务全面覆盖蕉赖全境各大成熟社区与商业街区，包括康乐花园（Taman Connaught）、美达花园（Taman Midah）、友力花园（Taman Yulek）、斯嘉镇（Taman Segar）、马鲁里（Maluri）、敦拉萨镇（Bandar Tun Razak），以及雪兰莪蕉赖南区的皇冠城（Bandar Mahkota Cheras）、双溪龙（Bandar Sungai Long）与蕉赖柏兰岭（Cheras Perdana）。",
      },
      {
        q: "如何确认我的蕉赖房屋应该向 DBKL 还是 MPKJ 申请装修准证？",
        a: "准证申报取决于您的地契与行政所属地：属于吉隆坡联邦直辖区的片区（如康乐、美达、友力、马鲁里）归 DBKL 管辖；属于雪兰莪州加影市议会辖区的片区（如皇冠城、双溪龙、无拉港）归 MPKJ 管辖。任何涉及房屋结构外扩、车房顶棚重建的工程，均须由注册建筑师向对应机构申请施工准证。",
      },
      {
        q: "针对蕉赖 30 年以上老排屋的顽固屋顶漏水与隔墙潮湿，如何根治？",
        a: "蕉赖老排屋多为联排瓦顶结构，渗水主要源于邻里共用隔墙水沟（Flashing）水泥老化及屋架局部沉降。我们在施工时会登顶排查更换断裂瓦片，重新铺设专业防水卷材与金属接水槽，并对室内共用隔墙进行抗潮封闭底漆处理，从源头阻断雨水与湿气渗入。",
      },
      {
        q: "在蕉赖捷运沿线的高层公寓进行装修，需要办理哪些手续？",
        a: "在 EkoCheras、Sunway Velocity 或 Aster 等高层公寓动工前，业主须向管理处（JMB/MC）提交施工平面图、缴纳装修抵押金、提供施工队工程全险（CAR）保单，并提前预约货运电梯使用权。所有敲墙、打钻等高噪音工序须严格限制在管理处规定的工作日时段内完成。",
      },
    ],
  },
  "subang-jaya": {
    ...
    nameZh: "梳邦再也",
    slug: "subang-jaya",
    metaTitle: "Terrace & Shop Renovation Subang Jaya | FLASH CAST",
    metaTitleZh: "梳邦再也装修服务 | 排屋翻新与商铺装修 | FLASH CAST",
    description: "Plan home or commercial renovation in Subang Jaya with FLASH CAST. Review USJ & SS terrace house updates, MBSJ guidelines, SS15 shop fit-outs, and quotation scope.",
    descriptionZh: "FLASH CAST 为梳邦再也（Subang Jaya）提供住宅排屋与商业店铺装修。涵盖 USJ / SS 区排屋翻新、MBSJ 报批、SS15 商业店铺 Fit-Out 与明细报价。",
    intro: "Subang Jaya is one of the most mature, established communities in the Klang Valley, characterized by sprawling residential neighbourhoods across USJ 1 through 27, the central SS sections (SS12–SS19), and dynamic commercial hubs like SS15 and Taipan USJ 10. Renovation projects in Subang Jaya predominantly centre around modernizing 1980s and 1990s double-storey terrace houses—often requiring single or double-storey rear kitchen extensions, converting single-phase electrical wiring to 3-phase, replacing concealed galvanized water pipes, and damp-proofing roofs. Additionally, commercial shoplots in SS15 and Taipan demand experienced coordination for retail, cafe, and restaurant fit-outs. Because Subang Jaya is the administrative headquarters of Majlis Bandaraya Subang Jaya (MBSJ), renovation alterations must adhere strictly to council building plan guidelines. FLASH CAST provides complete turnkey renovation, architectural submissions, trade coordination, and transparent cost planning across all Subang townships.",
    introZh: "梳邦再也（Subang Jaya）是巴生谷极具代表性的成熟宜居城镇，拥有覆盖 USJ 1 至 27 区、SS 核心区（SS12–SS19）的庞大住宅社区，以及 SS15 与 Taipan USJ 10 等极具活力的商业中心。在梳邦再也，大部分工程聚焦于 80、90 年代双层排屋的整体现代化翻新——包括后院厨房单层或双层扩建、单相电升级为三相电（3-Phase）、老旧镀锌铁管更换为抗老化 PPR 管，以及屋顶防水修缮。同时，SS15 与 Taipan 的商业店铺对餐饮排烟、油水分离与电气增容有着极高的实操要求。作为梳邦再也市政局（MBSJ）总部所在地，所有结构改造与商业招牌必须严格符合市政法规。FLASH CAST 为梳邦业主提供从现场测量、动线设计、图纸报批到施工交付的全程保障。",
    propertyTypes: [
      "Mature double-storey terrace houses (USJ 1-27, SS14, SS17, SS18, SS19)",
      "Commercial shophouses & cafe/retail units (SS15 Commercial Hub, Taipan USJ 10)",
      "Modern condominiums & serviced residences (Subang Olives, Saujana, SS16 Empire)",
      "Semi-detached & bungalow residences (Subang Heights, USJ 3D, SS19 Heights)",
      "Commercial office & business suites (Subang Square, USJ Sentral, One City)",
    ],
    propertyTypesZh: [
      "成熟双层排屋与有地住宅（USJ 1-27、SS14、SS17、SS18、SS19）",
      "商业街区商铺与餐饮咖啡店面（SS15 商业圈、Taipan USJ 10）",
      "现代高层公寓与服务式公寓（Subang Olives、Saujana、SS16）",
      "独立与半独立洋房（Subang Heights、USJ 3D、SS19）",
      "商业办公楼与企业套间（Subang Square、USJ Sentral、One City）",
    ],
    commonNeeds: [
      "Full terrace house modernization: single/double-storey rear kitchen extension and re-tiling",
      "Electrical rewiring from single-phase to 3-phase with modern breaker safety boxes",
      "Full plumbing overhaul: replacing concealed galvanized pipes with PPR / copper pipes",
      "SS15 commercial F&B and retail fit-out: kitchen exhaust ducting, greasetraps, and storefronts",
      "Custom wet and dry kitchen cabinetry with heavy-use stone countertops",
      "Custom whole-home built-in storage: bedroom wardrobes, study desks, and shoe cabinets",
    ],
    commonNeedsZh: [
      "老房排屋全屋现代化翻新：后院单/双层厨房扩建与全屋地砖重铺",
      "配电系统升级：单相电升级为三相电（3-Phase）、全屋暗线换新与安全电箱配置",
      "给排水管线彻底改造：老旧镀锌铁管更换为抗老化 PPR 或铜管，杜绝渗漏",
      "SS15 餐饮与商业门市 Fit-Out：排烟风管、油水分离器、门面招牌与电气负荷规划",
      "干湿分离厨房定制：防潮耐磨橱柜基材、石英石台面与大吸力抽油烟机点位",
      "全屋定制内嵌家具：卧室衣帽间、书房一体化书桌与玄关多功能鞋柜",
    ],
    constructionNotes: "Subang Jaya hosts the headquarters of Majlis Bandaraya Subang Jaya (MBSJ). For terrace house renovations involving rear kitchen extensions, car porch roof modifications, or removal of load-bearing walls, building plan submissions with registered architect and professional engineer endorsement are mandatory. Commercial renovations in high-density areas like SS15 and Taipan require MBSJ commercial renovation permits, signboard licensing, Bomba fire clearance, and strict scheduling of noisy hacking during permitted non-peak hours. For condominiums and serviced suites, contractors must comply with individual JMB/MC guidelines, including deposits, public liability insurance, and elevator protection.",
    constructionNotesZh: "梳邦再也是梳邦再也市政局（MBSJ）总部所在地。有地排屋若涉及后院厨房扩建、车房顶棚重做或打拆室内承重墙，必须由注册建筑师向 MBSJ 报批图纸并取得施工准证。在 SS15 与 Taipan 等高密度商业区进行店铺装修，须提前办理商业装修准证、招牌执照与消拯局（Bomba）合规检查，并严格将高噪音打拆工作控制在允许时段内。对于公寓或服务式公寓，承包商必须严格执行管理处（JMB/MC）规约，缴纳押金、购买保险并铺设电梯保护垫。",
    projects: [
      {
        title: "Dry & Wet Kitchen Cabinetry in Subang Jaya",
        type: "Built-In",
        image: kitchenImg,
      ...
      {
        title: "Commercial Restaurant & Dining Fit-Out",
        type: "Commercial",
        image: commercialImg,
        slug: "subang-jaya-restaurant-fit-out",
        href: "/projects/subang-jaya-restaurant-fit-out",
      },
      {
        title: "Subang Retail & Dining Space Planning",
        type: "Commercial",
        image: commercialImg,
        slug: "restaurant-fitout-subang",
        href: "/projects/restaurant-fitout-subang",
      },
    ],
    faqs: [
      {
        q: "Which areas in Subang Jaya do you serve for terrace and commercial renovations?",
        a: "We provide comprehensive renovation and fit-out services across all Subang Jaya precincts, including USJ 1 to USJ 27, SS12 through SS19, Subang Parade/Empire area, Putra Heights, Sunway, and surrounding neighbourhoods.",
      },
      {
        q: "What council permits are needed from MBSJ for a terrace house extension in Subang Jaya?",
        a: "If your renovation includes a rear kitchen extension, altering the car porch, knocking down structural walls, or constructing a second-storey extension, you must submit architectural and structural drawings to Majlis Bandaraya Subang Jaya (MBSJ) through a registered consultant. Cosmetic works like painting, custom wardrobes, or SPC flooring do not require MBSJ approval.",
      },
      {
        q: "Why do older terrace houses in USJ and SS areas often need a 3-phase electrical upgrade?",
        a: "Most older USJ and SS houses were constructed with single-phase power supply (30A–40A), which cannot safely support modern multiple air-conditioners, instant water heaters, induction cooktops, and EV home chargers. Upgrading to a 3-phase supply (60A) prevents frequent tripping, modernizes the safety fuse box, and ensures long-term electrical safety.",
      },
      {
        q: "How do you handle restaurant and retail shoplot renovations in the busy SS15 commercial square?",
        a: "We coordinate with MBSJ for commercial renovation permits and signboard approvals, design heavy-duty kitchen exhaust and greasetrap systems compliant with local council health requirements, and schedule heavy material loading and noisy hacking during off-peak morning or night hours to navigate SS15 traffic and parking constraints.",
      },
    ],
    faqsZh: [
      {
        q: "FLASH CAST 在梳邦再也（Subang Jaya）具体服务哪些片区？",
        a: "我们的服务全面覆盖梳邦再也各大成熟片区，包括 USJ 1 至 USJ 27 区、SS12 至 SS19 区、Empire / Subang Parade 周边、Putra Heights、双威（Sunway）及邻近社区。",
      },
      {
        q: "在梳邦再也进行排屋扩建，需要向 MBSJ 申请哪些准证？",
        a: "若涉及后院厨房扩建、车房顶棚改建、打拆承重墙或加建二楼，必须由具备资质的注册建筑师向梳邦再也市政局（MBSJ）报批建筑与结构图纸，取得准证后方可动工。纯室内装饰（如定制橱柜、墙面油漆、铺设地板）则无需市政报批。",
      },
      {
        q: "为什么 USJ 与 SS 区的老排屋通常需要升级三相电（3-Phase）？",
        a: "USJ 与 SS 区多数老房子早期为单相电（30A–40A），无法承载现代家庭多台变频空调、即热电热水器、电磁炉及电动车（EV）充电桩的同时运行。升级至三相电（60A）并更换现代漏电断路器电箱，能彻底杜绝跳闸隐患，保障用电安全。",
      },
      {
        q: "在繁忙的 SS15 商业圈进行餐厅或零售店铺装修，如何协调施工？",
        a: "我们协助业主向 MBSJ 申请商业装修与招牌执照，按照市政卫生规范设计强排油烟风管与油水分离系统，并将大宗材料进场与重噪音打拆工作安排在非营业或非高峰时段，以克服 SS15 繁华地段的交通与停车限制。",
      },
    ],
  },
  "mont-kiara": {
